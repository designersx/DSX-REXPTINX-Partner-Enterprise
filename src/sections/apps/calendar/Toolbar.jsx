...
export default function Toolbar({ date, view, onClickNext, onClickPrev, onClickToday, onChangeView, ...others }) {
  ...
  return (
    <Grid container spacing={downSM ? 1 : 3} {...others} sx={{ alignItems: 'center', justifyContent: 'space-between', pb: 3 }}>
      <Grid>
